...
const Data := preload('character_coco_state.gd')

var state: Data = load('res://popochiu/characters/coco/character_coco.tres')
...
func _on_click() -> void:
	match R.current.script_name:
		'LionKing01':
			Globals.set_room_branch(R.LionKing02, Globals.Branch.COCO)
		'LionKing02':
			say('Everyone will listen to me!!!')
