...
const Data := preload('character_popochiu_king_state.gd')

var state: Data = load('res://popochiu/characters/popochiu_king/character_popochiu_king.tres')
...
func _on_click() -> void:
	match R.current.script_name:
		'LionKing01':
			Globals.set_room_branch(R.LionKing02, Globals.Branch.POPOCHIU_KING)
		'LionKing02':
			say("Vivan los popochius!!!")
